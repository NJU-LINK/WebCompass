#!/usr/bin/env python3
"""
WebCompass Evaluation - Text-to-Web Inference
...
from generation.inference import TextToWebGenerator
...
def main():
    parser = argparse.ArgumentParser(description="Text-to-Web inference")
